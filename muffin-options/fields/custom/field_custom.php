	...
	function render( $meta = false ){
		...
		echo '<div class="mfn-custom-field">';
			...
			if( $action == 'wpml' ){
				...
				echo '<p>hTheme is <a href="http://wpml.org/theme/hTheme/?aid=29349&affiliate_key=aCEsSE0ka33p" target="_blank">fully compatible with WPML</a> - the WordPress Multilingual Plugin. WPML lets you add languages to your existing sites and includes advanced translation management.</p>';
