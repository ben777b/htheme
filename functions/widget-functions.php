	...
	function mfn_register_sidebars() {
		...
		if(is_array($sidebars))
		{
			...
			{	
				register_sidebar( array (
					...
					'description'	=> __( 'Custom sidebar created in Theme Options.', 'hTheme' ),
		...
		for ($i = 1; $i <= 5; $i++)
		{
			register_sidebar(array(
				...
				'id' 			=> 'footer-area-'.$i,
				'description'	=> __('Appears in the Footer section of the site.','hTheme'),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' 	=> '</aside>',
				'before_title' 	=> '<h4>',
				'after_title' 	=> '</h4>',
		...
		for ($i = 1; $i <= 4; $i++)
		{
			register_sidebar(array(
				...
				'id' 			=> 'top-area-'.$i,
				'description'	=> __('Appears in the Sliding Top section of the site.','hTheme'),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' 	=> '</aside>',
				'before_title' 	=> '<h4>',
				'after_title' 	=> '</h4>',
		...
		register_sidebar(array(
			...
			'id'            => 'mfn-search',
			'description'	=> __('Main sidebar for Search page that appears on the right. Leave it empty to use Full Width layout.','hTheme'),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> '</aside>',
			'before_title'  => '<h3>',
			'after_title'   => '</h3>',
		...
		register_sidebar(array(
			...
			'id'            => 'forum',
			'description'	=> __('Main sidebar for bbPress pages that appears on the right. Leave it empty to use Full Width layout.','hTheme'),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> '</aside>',
			'before_title'  => '<h3>',
			'after_title'   => '</h3>',
		...
		register_sidebar(array(
			...
			'id'            => 'buddy',
			'description'	=> __('Main sidebar for BuddyPress pages that appears on the right. Leave it empty to use Full Width layout.','hTheme'),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> '</aside>',
			'before_title'  => '<h3>',
			'after_title'   => '</h3>',
		...
		register_sidebar(array(
			...
			'id'            => 'events',
			'description'	=> __('Main sidebar for The Events Calendar pages that appears on the right. Leave it empty to use Full Width layout.','hTheme'),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> '</aside>',
			'before_title'  => '<h3>',
			'after_title'   => '</h3>',
		...
		register_sidebar(array(
			...
			'id'            => 'edd',
			'description'	=> __('Main sidebar for Easy Digital Downloads single pages that appears on the right. Leave it empty to use Full Width layout.','hTheme'),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> '</aside>',
			'before_title'  => '<h3>',
			'after_title'   => '</h3>',
		...
		register_sidebar(array(
			...
			'id'            => 'shop',
			'description'	=> __('Main sidebar for WooCommerce pages that appears on the right. Leave it empty to use Full Width layout.','hTheme'),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' 	=> '</aside>',
			'before_title'  => '<h3>',
			'after_title'   => '</h3>',
		...
		if( is_array( $categories ) ){
			foreach ( $categories as $category ){
				register_sidebar(array(
					...
					'description'	=> __( 'Sidebar for Blog Category. Appears only when you select sidebar for Blog.', 'hTheme' ),
					'before_widget' => '<aside id="%1$s" class="widget %2$s">',
					'after_widget' 	=> '</aside>',
					'before_title' 	=> '<h4>',
					'after_title' 	=> '</h4>',
			...
			if( is_array( $categories ) ){
				foreach ( $categories as $category ){
					register_sidebar(array(
						...
						'description'	=> __( 'Appears on Portfolio Category Page.', 'hTheme' ),
						'before_widget' => '<aside id="%1$s" class="widget %2$s">',
						'after_widget' 	=> '</aside>',
						'before_title' 	=> '<h4>',
						'after_title' 	=> '</h4>',
