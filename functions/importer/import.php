...
class mfnImport {
	...
	function get_demo_url( $demo ){
		if( $demo == 'be' ){
			$url = 'http://themes.muffingroup.com/hTheme/';
		} else {
					...
					<?php if( ! $this->error ): ?>
						...
						<div class="import-all-done item" data-id="<?php echo $demo; ?>">
							...
							<div class="done-learn">
								<span>or</span>
								<div class="learn-header">Learn more about hTheme</div>
								Remember, it is a good practise to read the manual first
							</div>
							
							<div class="done-help">
								<a target="_blank" href="http://themes.muffingroup.com/hTheme/documentation/">
									<span class="dashicons dashicons-info"></span>
									Learn how to use hTheme from our manual
								</a>
							</div>
													...
													echo '<ul class="plugins-used">';
														...
														if( ( $plugins_key = array_search( 'rev', $demo['plugins'] ) ) !== false ){
															...
															echo '<li class="plugin-rev">';
																...
																echo '<a target="_blank" href="http://themes.muffingroup.com/hTheme/documentation/#slider">How to import slider</a>';
															echo '</li>';
