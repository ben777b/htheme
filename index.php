...
$translate['item-all'] 		= mfn_opts_get('translate') ? mfn_opts_get('translate-item-all','All') : __('All','hTheme');
?>
						...
						<div class="blog_wrapper isotope_wrapper">
							...
							<?php	
								...
								if( function_exists( 'mfn_pagination' ) ):
									...
									?>
										<div class="nav-next"><?php next_posts_link(__('&larr; Older Entries', 'hTheme')) ?></div>
										<div class="nav-previous"><?php previous_posts_link(__('Newer Entries &rarr;', 'hTheme')) ?></div>
									<?php
								endif;
							?>
