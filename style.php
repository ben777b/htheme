...
<?php
	...
	if( is_array( mfn_opts_get( 'font-size-content' ) ) ){
		...
		// compatibility with hTheme < 13.5
...
<?php 
	$translate['before'] 	= mfn_opts_get('translate') ? mfn_opts_get('translate-before','Before') : __('Before','hTheme');
	$translate['after'] 	= mfn_opts_get('translate') ? mfn_opts_get('translate-after','After') : __('After','hTheme');
?>
